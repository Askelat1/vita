...
function Header(props) {
    ...
    const nav_links = (user)? (
        ...
        <div className={module.nav_block}>
            <a className={module.nav_item} href="/vita/mainOffice">Личный кабинет</a>
        </div>
        );
        ...
        const nav_icons = (user)? (
            <nav className={module.nav}>                
                <div className={module.icon}>
                    <Link to="/vita/korzina"><img className={module.nav__item} src={shop}></img></Link>
                    {/* <Link to="#"><img className={module.nav__item} src={favorite}></img></Link> */}
                    <Link to="/vita/main"><img className={module.nav__item} src={login}></img></Link>
            ...
            <nav className={module.nav}>                
                <div className={module.icon}>
                    ...
                    <Link to="/vita/mainOffice"><img className={module.nav__item} src={login}></img></Link>
    ...
    return (
        <header>
            <nav className={module.nav}>
                <Link to='/vita/mainPages'><img className={module.logo} src={logo}></img></Link>
                {nav_links}
                {nav_icons}
